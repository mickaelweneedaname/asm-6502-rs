...
drawSnake:
; ldx #0
  ldx $03      ;set the value of the X register to 0
; lda #1
  lda #0      ;set the value of the A register to 1
...
; ldx $03
  ldx #0     ;set the value of the x register to the value stored in memory at
              ;location $03 (the length of the snake)
; lda #0
  lda #1      ;set the value of the a register to 0
  sta ($10,x) ;dereference to the memory address that's stored at address
